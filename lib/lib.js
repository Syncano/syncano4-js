	...
	Syncano.prototype = {
		...
		*/
		...
		getClass: function(name, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_classes + name, {}, function(obj) {
		...
		*********************/
		...
		removeWebHook: function(id, callbackOK, callbackError) {
			...
			return this.request('DELETE', linksObject.instance_webhooks + id, {}, callbackOK, callbackError);
		},
