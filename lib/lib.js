	...
	*/
	...
	Syncano.prototype = {
		...
		**********************/
		...
		listInstances: function(callbackOK, callbackError) {
			return this.request('GET', 'v1/instances', {}, callbackOK, callbackError);
		},
		...
		listInstanceAdmins: function(name, callbackOK, callbackError) {
			if (typeof name === 'object') {
				name = name.name;
			}
			if (typeof name === 'undefined' || name.length === 0) {
			...
			return this.request('GET', 'v1/instances/' + name + '/admins/', {}, callbackOK, callbackError);
		},
		...
		********************/
		...
		accountResetKey: function(callbackOK, callbackError) {
