	...
	*/
	function Syncano(param) {
		...
		this.Instances = {
			...
			remove: self.removeInstance.bind(self),
		...
		this.Classes = {
			...
			remove: self.removeClass.bind(self),
		...
		this.DataObjects = {
			...
			remove: self.removeDataObject.bind(self),
			get: self.getDataObject.bind(self),
			update: self.updateDataObject.bind(self)
		};
		this.ApiKeys = {
			create: self.createApiKey.bind(self),
			list: self.listApiKeys.bind(self),
			get: self.getApiKey.bind(self),
			remove: self.removeApiKey.bind(self)
		};
		this.CodeBoxes = {
			create: self.createCodeBox.bind(self),
			list: self.listCodeBoxes.bind(self),
			listRuntimes: self.listCodeBoxRuntimes.bind(self),
			get: self.getCodeBox.bind(self),
			update: self.updateCodeBox.bind(self),
			remove: self.removeCodeBox.bind(self)
		};
		this.Invitations = {
			create: self.createInvitation.bind(self),
			list: self.listInvitations.bind(self),
			get: self.getInvitation.bind(self),
			remove: self.removeInvitation.bind(self)
		};
		this.WebHooks = {
			create: self.createWebHook.bind(self),
			list: self.listWebHooks.bind(self),
			get: self.getWebHook.bind(self),
			update: self.updateWebHook.bind(self),
			remove: self.removeWebHook.bind(self),
			run: self.runWebHook.bind(self)
		};
	}
	...
	Syncano.prototype = {
		...
		*********************/
		...
		listApiKeys: function(params, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_api_keys, params, callbackOK, callbackError);
		},
		...
		getApiKey: function(id, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_api_keys + id, {}, callbackOK, callbackError);
		},
		...
		removeApiKey: function(id, callbackOK, callbackError) {
			...
			return this.request('DELETE', linksObject.instance_api_keys + id, {}, callbackOK, callbackError);
		},
		...
		**********************/
		...
		listCodeBoxes: function(params, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_codeboxes, params, callbackOK, callbackError);
		},

		listCodeBoxRuntimes: function(params, callbackOK, callbackError) {
			params = params || {};
			if (typeof linksObject.instance_codebox_runtimes === 'undefined') {
				throw new Error('Not connected to any instance');
			}
			return this.request('GET', linksObject.instance_codebox_runtimes, params, callbackOK, callbackError);
		},
		...
		getCodeBox: function(id, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_codeboxes + id, {}, callbackOK, callbackError);
		},
		...
		removeCodeBox: function(id, callbackOK, callbackError) {
			...
			return this.request('DELETE', linksObject.instance_codeboxes + id, {}, callbackOK, callbackError);
		},
		...
		************************/
		...
		listInvitations: function(params, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_invitations, params, callbackOK, callbackError);
		},
		...
		getInvitation: function(id, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_invitations + id, {}, callbackOK, callbackError);
		},
		...
		removeInvitation: function(id, callbackOK, callbackError) {
			...
			return this.request('DELETE', linksObject.instance_invitations + id, {}, callbackOK, callbackError);
		},
		...
		*********************/
		...
		listWebHooks: function(params, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_webhooks, params, callbackOK, callbackError);
		},
		...
		getWebHook: function(id, callbackOK, callbackError) {
			...
			return this.request('GET', linksObject.instance_webhooks + id, {}, callbackOK, callbackError);
		},

		updateWebHook: function(id, callbackOK, callbackError) {
