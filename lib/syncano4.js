	...
	*/
	...
	Syncano.prototype = {
		...
		*********************/
		 ...
		 * TODO
		 */
		getChannel: function(id, callbackOK, callbackError) {
			return this.genericGet(id, 'instance_channels', callbackOK, callbackError);
		},

		/**
		 * TODO
		 */
		removeChannel: function(id, callbackOK, callbackError) {
			return this.genericRemove(id, 'instance_channels', callbackOK, callbackError);
		},
		 ...
		 * TODO
		 */
		channelListen: function(channel, callback) {
			...
			var url = baseURL + linksObject.instance_channels + channel + '/poll/';
			if (apiKey !== null) {
		...
		publishToChannel: function(channel, params, callbackOK, callbackError) {
			if (typeof channel !== 'string') {
				channel = channel.name;
			}
			if (typeof channel !== 'string') {
			...
			var url = linksObject.instance_channels + channel + '/publish/';
		 ...
		 * TODO
		 */
		getChannelHistory: function(channel, callbackOK, callbackError) {
			if (typeof channel !== 'string') {
				channel = channel.name;
			}
			if (typeof channel !== 'string') {
			...
			var url = linksObject.instance_channels + channel + '/history/';
			return this.request('GET', url, {}, callbackOK, callbackError);
		},
